...
public class Indexer extends SubsystemBase {
    ...
    private static final LoggedTunableNumber kI = new LoggedTunableNumber(
        "Indexer/kI",
        0.0
    );
    ...
    private final Debouncer motorConnectedDebouncer = new Debouncer(
        0.5,
    ...
    public void periodic() {
        ...
        if (closedLoop) {
            double toleranceRadPerSec =
                Units.rotationsPerMinuteToRadiansPerSecond(50);
            atSetpoint = EqualsUtil.epsilonEquals(
        ...
        Logger.recordOutput(
            "Indexer/Profile/SetpointVelocityRadPerSec",
            velocitySetpointRadPerSec
        );
        Logger.recordOutput(
        ...
        Logger.recordOutput(
            "Indexer/Profile/ActualVelocityRadPerSec",
            inputs.velocityRadPerSec
        );
        Logger.recordOutput(
